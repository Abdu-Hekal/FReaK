...
gamma=0.007;
bench.requirements = {; ...
    "AFC27", globally(implies(rise2|fall2,globally(abs(x(1))<beta,interval(1,5))),interval(11,50)); ... 
%     "AFC27", globally(implies((u(1) < 8.8),globally(abs(x(1))<beta,interval(1,5))),interval(11,50)); ... 
%     "testAFC27", globally(implies((u(1) < 8.8),globally(abs(x(1))<beta,interval(1,5))),interval(11,50)); ... 
%     "testAFC27", globally(implies((u(1) < 8.8),globally(abs(x(1))<beta,interval(1,5))),interval(11,50)); ... 
%     "testAFC27", globally(finally(u(1) > 40.0,interval(0,0.05),interval(11,50)); ...
