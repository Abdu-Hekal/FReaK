...
%     "AT6a", implies(globally(x(2)<3000,interval(0,30)),globally(x(1)<35,interval(0,4))); ...
    ...
    %      "test", finally(x(2)<3500 | x(2)>4000,interval(10,30)),...
%             "testAT52", globally(implies(~(x(3)>1.1 & x(3)<2.9) & finally(x(3)>1.1 & x(3)<2.9,interval(0.001,0.1)),finally(globally(x(3)>1.1 & x(3)<2.9,interval(0,2.5)),interval(0.001,0.1))),interval(0,30)); ...
            "testAT52", globally(implies(~(x(3)>=2 & x(3)<=2) & finally(x(3)>=2 & x(3)<=2,interval(0.001,0.1)),finally(globally(x(3)>=2 & x(3)<=2,interval(0,2.5)),interval(0.001,0.1))),interval(0,30)); ...
    };
benches{end+1} = bench;
