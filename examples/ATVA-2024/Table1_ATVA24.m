function Table1_ATVA24()
% Table1_ATVA24 - runs all experiments in table 1 in the paper Fast Koopman Surrogate Falsification using
%  Linear Relaxations and Weights, ATVA 2024.
%
% Syntax:
%   results = Table1_ATVA24()
%
% Inputs:
%    -
%
...
for b = 1:length(benches)
    ...
    for i = 1:size(req, 1)
        ...
        kfModel.solver.autoAddConstraints=1;
