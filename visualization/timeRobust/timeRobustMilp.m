function [F,P] = timeRobustMilp(phi,kList,kMax,ts,var,M)
% timeRobustMilp  constructs MILP constraints in YALMIP that compute
%                  the time robustness of satisfaction for specification phi
%
% Input:
%       phi:    an STLformula
...
switch (phi.type)
    ...
    case '=>'
        error('implies stl operator not directly implemented for time robustness')
    ...
    case 'until'
        error('until stl operator not implemented for time robustness')
