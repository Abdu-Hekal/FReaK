...
data_output = fullfile(aerobench_path,'src/results/SimResults.mat');
image_output = fullfile(aerobench_path,'src/results/output_picture');
animation_output = fullfile(aerobench_path,'src/results/output_animation');
